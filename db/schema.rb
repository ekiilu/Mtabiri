...
ActiveRecord::Schema.define(:version => 20120603054553) do
  ...
  create_table "cattlethefts", :force => true do |t|
  ...
  create_table "conflict_reports", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "conflictreports", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "conflictreps", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "locationreports", :force => true do |t|
    t.string   "index"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "nightattacks", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "roadcrimes", :force => true do |t|
    t.string   "nationalid"
    t.string   "location"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
